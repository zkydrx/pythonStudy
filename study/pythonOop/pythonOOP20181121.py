...
print(Student('Abbot'))  # =><__main__.Student object at 0x00000180ADDF6390>


# 打印出一堆<__main__.Student object at 0x00000180ADDF6390>，不好看。
#
...
print(Student('Abbot'))  # =>Student object (name:Abbot)
...
class Student(object):
    ...
    def __getattr__(self, item):
        if item == 'age':
            return lambda: 25
        raise AttributeError('\'Student\' object has not attribute \'%s\'' % item)
