...
std1 = {'name': 'Michael', 'score': 81}
std1 = {'name': 'Bob', 'score': 91}
...
bart.print_score()  # =>Bart Simpson:88
lisa.print_score()  # =>Lisa Simpson:99
...
bart = Student()
print(bart)  # =><__main__.Student object at 0x000001A523799908>
# 可以看到，变量bart指向的就是一个Student的实例，后面的0x10a67a590是内存地址，每个object的地址都不一样，而Student本身则是一个类。
#
# 可以自由地给一个实例变量绑定属性，比如，给实例bart绑定一个name属性：
bart.name = 'Abbot'
print(bart.name)  # =>Abbot
...
bart = Student('Tom', 89)
print(bart.name, bart.score)  # =>Tom 89
...
lisa = Student('lisa math',89)
tom = Student('Tom math',99)
print(lisa.print_grade()) # => B
print(tom.print_grade())  # => A
